...
def run_single_experiment(data: Dict, cfg: AutoConstructiveConfig, logger: Any):
    ...
    auto_constructive = AutoConstructiveModel(
        ...
        monitored_metric_add_layers=cfg.training.monitored_metric_add_layers,
        monitored_objective=cfg.training.monitored_objective,
        pareto_frontier=cfg.training.pareto_frontier,
        ...
        improvement_strategy=cfg.model.improvement_strategy,
